...
namespace WebApiAutores.Controllers
{
    ...
    public class ComentariosController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post(int libroId, ComentarioCreacionDTO comentarioDTO)
        {
            ...
            var comentarioCreacionDTO = mapper.Map<ComentarioDTO>(comentario);

            return CreatedAtRoute("ObtenerComentario", new { id = comentario.Id, libroId = libroId }, comentarioCreacionDTO);
        }

        [HttpPut("{id:int}", Name = "ActualizarComentario")]
        public async Task<ActionResult> Put(ComentarioCreacionDTO comentarioDTO, int id, int libroId)
        {
            var existeLibro = await context.Libros.AnyAsync(libroDB => libroDB.Id == libroId);
